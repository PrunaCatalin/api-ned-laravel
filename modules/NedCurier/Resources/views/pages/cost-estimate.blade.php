...
@section('content')
    <main class="estimate-the-price-page " id="main">
        <section class=" breadcumb align-center">
            <div class="container">
                <div class="row">
                    <h2 class="track-the-expedition-title">Trimite colet</h2>
        ...
        <form>
            <section id="about" class="about estimate-the-price">
                <div class="container">
                    <div class="row">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="text-right">
                            <a href="#" class=" submit btn-get-started buton-formular-contact">Plaseaza comanda</a>
                        </div>
                    </div>
                </div>
            </section>
