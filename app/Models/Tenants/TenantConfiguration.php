...
class TenantConfiguration extends Model
{
     ...
     * @var string
     */
    protected $table = 'system_tenant_configuration';
     ...
     */
    protected $fillable = [
        'domain_id', 'endpoint', 'username', 'password',
        'secret', 'tenant_type', 'created_at', 'updated_at', 'deleted_at'
    ];
     ...
     */
    protected $casts = [
        'domain_id' => 'int', 'endpoint' => 'string', 'username' => 'string',
        'password' => 'string', 'secret' => 'string', 'tenant_type' => 'string',
