<template>
    <header class="header">
        <div class="logo-wrapper">
            <router-link to="/" class="logo">
                <img :src="'img/logo-dark.png'" :alt="nameApp" />
            </router-link>
            ...
            <ul class="header-actions">
                            ...
                            <li>
                                <a href="#">
                                    <div class="user-img away">
                                        <img src="img/stripes.png" alt="User" />
                                    </div>
                                    <div class="details">
                ...
                <li class="dropdown">
                    <a href="#" id="userSettings" class="user-settings" data-toggle="dropdown" aria-haspopup="true">
                        ...
                        <span class="avatar">{{ User.nameLetters }}<span class="status busy"></span></span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userSettings">
                        <div class="header-profile-actions">
                            ...
                            <a @click="logoutSalesforce" v-if="userStoreStorage.IsSalesforceUser"><i class="icon-log-out1"></i> Sign Out Salesforce</a>
                            <a @click="openSalesforceLogin" v-if="!userStoreStorage.IsSalesforceUser"><i class="icon-login"></i> Login Salesforce</a>
    ...
    <transition name="bounce" mode="out-in">
        <SalesforceLogin :show="openSalesforceModal"
                         @cb-loginSalesforce="loginSalesforce"
                         @cb-hideSalesforceLogin="hideSalesforceLogin"
        ></SalesforceLogin>
    </transition>
</template>
...
import SalesforceLoginComponent from "../modules/Auth/components/SalesforceLoginComponent";
import { UserStoreStorage } from '../modules/Users/store/UserStoreStorage';

export default {
    name: "HeaderComponent",
    components : {
        SalesforceLogin : SalesforceLoginComponent
    },
    setup(){
    ...
    data() {
        return {
            ...
            User : this.userStoreStorage.User ,
            IsLoginSalesforce : this.userStoreStorage.IsSalesforceUser,
    ...
    methods : {
        ...
        logoutSalesforce(){
            AuthService.logoutSalesforce();
        },
        loginSalesforce(){
            this.openSalesforceModal = false;
        },
        hideSalesforceLogin(){
            this.openSalesforceModal = false;
        },
