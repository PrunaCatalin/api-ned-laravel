...
Utils.getRequestDataFormArray = function(object){
    let serialized = $(object).serializeArray();
    let data = {};
...
Utils.showErrors = function(errors, selector, prefixError) {

    document.querySelectorAll("." + selector).forEach(function(errorDiv) {
        errorDiv.innerHTML = '';
    });
